...
[linha de assinatura do representante legal]`;
    ...
    // Título limpo para CRM — sem prefixo
    ...
    // Buscar etapa "Proposta" do funil dinamicamente pelo company_id
    ...
    // Criar deal no funil — verificar por opportunity_id E source='ai_proposal'
    if (proposalStage) {
      ...
      console.warn(`Etapa "Proposta" não encontrada no funil para company_id ${company_id}`);
    }
